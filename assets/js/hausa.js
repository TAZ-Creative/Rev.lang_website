...
translateBtn.addEventListener("click", () => {
  ...
  let translateFrom = "ha-NG"; //langauge value to translate from
      ...
      messages: [
        {
          role: "user",
          content:
            "Generate an everyday word in Hausa language. Strictly write only this single word and nothing else.",
        },
      ],
    }),
  })
